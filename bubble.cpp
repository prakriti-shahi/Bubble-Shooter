...
const int BUBBLE_DEFAULT_AY = 10;

class Bubble
{
private:
    Circle circle;  // the circle representing the bubble
    double vx, vy, ay;  // velocity in x and y direction and acceleration in y direction
...
public:
    ...
    void nextStep(double t)
    {
        ...
        if ((vy > 0 && new_y > (WINDOW_Y - 50 - circle.getRadius()))) // bounce along Y direction at bottom
        {
            ...
            vy = -vy;
            new_y = circle.getY() + vy*t + 0.5*ay*t*t;
    ...
    double get_ay()
    {
        // return the y acceleration of the bubble
        return ay;
    }
    Color get_color()
    {
